// Same as GPU5 but N must be a multiple of the block size to take away the check if id < N																																							
// nvcc nbodyGPU6.cu -o GPU6 -lglut -lm -lGLU -lGL
